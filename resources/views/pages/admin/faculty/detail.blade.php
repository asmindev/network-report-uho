...
<div class="w-full flex items-center justify-center">
    <div class="w-full">
        ...
        <div class="bg-white w-full px-6 py-4 rounded-xl">
            <h1 class="text-2xl font-bold text-gray-800">Fakultas {{ $faculty->name }}</h1>
        </div>
        <div class="mt-4">
                ...
                <table class="w-full table-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                        ...
                        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                            Daftar Jurusan di Fakultas {{ $faculty->name }}
                        </p>
                    </caption>
                    ...
                    <tbody>
                        @if (count($faculty->majors) > 0)
                        @foreach ($faculty->majors as $mjr)
